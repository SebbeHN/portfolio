...
const projects = [
  { title: 'Öl-priser', type: 'Webbapp', year: 'Projekt', description: 'En tjänst för att hitta billigast öl runt om i Malmö och sortera alternativ efter exempelvis pris eller avstånd.', image: 'https://images.unsplash.com/photo-1515003197210-e0cd71810b5f?auto=format&fit=crop&w=1200&q=85', href: 'https://github.com/SebbeHN/olpriser', tone: 'project--coral' },
